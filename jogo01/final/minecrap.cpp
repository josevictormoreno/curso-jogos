...
Minecrap::Minecrap(){
  // window
  window.create(sf::VideoMode(1280,720), "Minecrap - 1.0", sf::Style::Titlebar | sf::Style::Close);
  ...
  texture.loadFromFile("./assets/img/minecrap.png");
  bg.loadFromFile("./assets/img/fundo.jpg");
  hammer.loadFromFile("./assets/img/hammer.png");
  stop.loadFromFile("./assets/img/paused.jpg");
  ...
  x = static_cast<float>( std::experimental::randint(10, (int)(window.getSize().x - texture.getSize().x - 10) ) );
